      ...
      <section className="py-20">
        <div className="section-container">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Basic Training */}
            <div className="bg-surface/50 border-2 border-white/10 rounded-2xl p-8 hover:border-brand-primary/50 transition-all">
            ...
            <div className="bg-gradient-to-b from-brand-primary to-brand-primary/80 border-2 border-brand-primary rounded-2xl p-8 transform scale-105 relative">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-black px-4 py-1 rounded-full text-sm font-bold text-brand-primary border border-brand-primary">
                MOST POPULAR
              </div>
              ...
              <Link href="/download" className="bg-white hover:bg-white/90 text-black font-bold py-4 rounded-full w-full block text-center mb-8 transition-all">
                Get Started
              </Link>
        ...
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface/50 border border-gray-800 rounded-xl p-8">
                <h3 className="text-2xl font-bold text-white mb-4">1-Hour Session</h3>
                <div className="text-4xl font-bold text-brand-primary mb-6">$200</div>
              ...
              <div className="bg-surface/50 border border-gray-800 rounded-xl p-8">
                ...
                <div className="text-4xl font-bold text-brand-primary mb-6">$400</div>
                <ul className="space-y-3 text-gray-400">
                  <li className="flex items-start">
                    <span className="text-brand-primary mr-2">•</span>
            ...
            <div className="mt-8 bg-brand-primary/10 border border-brand-primary/30 rounded-xl p-6 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface/50 border border-gray-800 rounded-xl p-8">
                ...
                <div className="text-3xl font-bold text-brand-primary mb-4">$2,500 - $5,000</div>
              ...
              <div className="bg-surface/50 border border-gray-800 rounded-xl p-8">
                ...
                <div className="text-3xl font-bold text-brand-primary mb-4">$15,000 - $35,000</div>
                <p className="text-gray-400 mb-6">per month</p>
                <ul className="space-y-3 text-gray-400">
                  <li className="flex items-start">
                    <span className="text-brand-primary mr-2">•</span>
        ...
        <div className="section-container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-surface/50 border border-gray-800 rounded-xl p-6">
